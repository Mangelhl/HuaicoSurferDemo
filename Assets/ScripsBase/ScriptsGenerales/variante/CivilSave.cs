...
public class CivilSave : MonoBehaviour
{
    ...
    private void Awake()
    {
        CS = GameObject.FindGameObjectWithTag("Victimas").GetComponent<TMP_Text>();
    ...
    void Start()
    {
        CS.text = " " + PlayerPrefs.GetInt("Civiles Salvados", 0).ToString();
